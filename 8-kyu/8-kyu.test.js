...
/**
<<<<<<< HEAD
 * Función que añade la palabra 'Helo World' al final de la la frase
 * que se le pase como argumento
=======
 * Función que devuelve la palabra Hello World
>>>>>>> 2f452f089c50341c7f524e3c7d605024534464e2
 */
it("getHelloWorld", () => {
...
it("replaceWordInSentence", () => {
  expect(
    replaceWordInSentence(
      "¿Hola <name>, que tal llevas las clases?",
      "<name>",
      "Tahiche"
    )
  ).toEqual("¿Hola Tahiche, que tal llevas las clases?");
  expect(
    replaceWordInSentence(
      "Esto es un mensaje de <company>:",
      "<company>",
      "Tahi Evil Corp."
    )
  ).toEqual("Esto es un mensaje de Tahi Evil Corp.:");
  expect(
    replaceWordInSentence(
      "¿Hola <name>, que tal llevas las clases?",
      "",
  ...
  ).toEqual("¿Hola <name>, que tal llevas las clases?");
  expect(
    replaceWordInSentence(
      "¿Hola <name>, que tal llevas las clases?",
      null,
